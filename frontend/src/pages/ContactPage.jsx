          ...
          <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} className="lg:col-span-2 space-y-6">
            <div className="glass rounded-2xl p-6">
              ...
              <div className="space-y-4">
                {[
                  { icon: FiMail, label: 'Email', value: 'manishamakeover.academy047@gmail.com', href: 'mailto:manishamakeover.academy047@gmail.com' },
                  { icon: FiPhone, label: 'Phone / WhatsApp', value: '+91 XXXXXXXXXX', href: 'tel:+919876543210' },
