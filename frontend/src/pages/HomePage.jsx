...
const features = [
  {
    ...
    desc: "Join real-time classes via Google Meet with our expert instructors and get personalized feedback.",
  },
  {
    icon: "📄",
    title: "Premium PDF Notes",
    desc: "Download comprehensive study materials, assignments, and beauty guides after each class.",
  },
  {
    icon: "🏆",
    title: "Industry Certificates",
    desc: "Earn QR-verified certificates recognized by top salons and beauty brands across India.",
  },
  {
    icon: "👩‍🏫",
    title: "Expert Mentorship",
    desc: "Get one-on-one guidance from professional makeup artists with 10+ years of experience.",
  },
  {
    icon: "📊",
    title: "Attendance Tracking",
    desc: "Monitor your learning progress with detailed attendance and performance analytics.",
  },
  {
    icon: "💬",
    title: "24/7 Community Support",
    desc: "Connect with fellow students and instructors through our exclusive WhatsApp groups.",
  },
];
...
const testimonials = [
  {
    ...
    text: "Manisha Makeover Academy transformed my life! I started my own salon within 3 months of completing the bridal makeup course.",
    rating: 5,
  },
  {
    name: "Kavya Singh",
    ...
    text: "The live classes are so interactive. My instructor's feedback helped me perfect my blending techniques in just 2 weeks.",
    rating: 5,
  },
  {
    name: "Ananya",
    ...
    text: "The certificate I got from here helped me land my dream job at a luxury wedding studio. Highly recommended!",
    rating: 5,
  },
];
...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    const loadPurchases = async () => {
      try {
        const res = await api.get("/class-purchase/my");

        setPurchasedClasses(
          res.data.purchases.map((p) => p.classId.toString()),
        );
      } catch (err) {
        console.log(err);
      }
  ...
  return (
    <div className="overflow-x-hidden relative">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-24 pb-16 overflow-hidden">
        ...
        />
        <div
          className="orb w-80 h-80 bg-purple-600 bottom-20 -right-40"
          style={{ opacity: 0.12 }}
        />
        <div
          className="orb w-64 h-64 bg-rose-400 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
          style={{ opacity: 0.06 }}
        />
        ...
        <div className="relative max-w-5xl mx-auto px-6 flex flex-col items-center justify-center text-center">
          <motion.div variants={stagger} initial="hidden" animate="visible">
            <motion.div
              variants={fadeUp}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-pink-500/20 mb-8"
            >
            ...
            >
              Learn from beauty experts through{" "}
              <span className="text-pink-600 font-semibold">
                live interactive classes
              </span>
              , premium notes, mentorship, and certification programs designed
            ...
            >
              {stats.map(({ value, label, icon: Icon }) => (
                <div
                  key={label}
                  className="glass rounded-[30px] p-6 text-center backdrop-blur-glass"
                >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-white max-w-2xl mx-auto">
              From live classes to certification, we provide a complete
              ecosystem for your beauty education journey.
            </p>
          </motion.div>
      ...
      {upcoming.length > 0 && (
        <section
          ...
          style={{ background: "rgba(233,30,140,0.03)" }}
        >
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {upcoming.slice(0, 3).map((cls, i) => {
                const hasPurchased = purchasedClasses.includes(cls._id);
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-white">
              Flexible plans designed to match your learning goals and budget.
            </p>
          </motion.div>
              ...
              >
                {plan.popular && (
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                    <span
                      className="px-4 py-1 rounded-full text-xs font-bold text-purple-900"
                      style={{
                ...
                <div
                  className={`w-12 h-12 rounded-2xl bg-gradient-to-br ${plan.color} flex items-center justify-center text-purple-900 text-xl mb-4`}
                >
                  {i === 0 ? "🌸" : i === 1 ? "💎" : "👑"}
                </div>
                ...
                <Link
                  to="/pricing"
                  className={`block text-center rounded-full py-3 font-semibold text-sm transition-all ${plan.popular ? "btn-primary" : "btn-outline"}`}
                >
                  Get Started
                </Link>
              </motion.div>
          ...
          >
            ...
            >
              ...
              <p className="text-white mb-8 max-w-xl mx-auto">
                Join 5000+ students who have transformed their passion into a
