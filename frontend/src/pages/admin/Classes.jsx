                ...
                <thead>
                  <tr style={{ background: "rgba(255,255,255,0.03)" }}>
                    {[
                      ...
                      <th
                        key={h}
                        className="text-left px-4 py-3 text-gray-400 text-xs font-medium uppercase whitespace-nowrap"
                      >
                        {h}
                      </th>
                    ))}
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-3">
                          <img
                            src={
                              cls.thumbnail ||
                              "https://images.unsplash.com/photo-1487412947147-5cebf100ffc2?w=60"
                            }
                            alt=""
    ...
    <div className="flex flex-col">
      ...
      <span className="text-xs text-gray-400">
        Batch
                      ...
                      <td className="px-4 py-3">
                        <span
                          className={`px-2 py-1 rounded-full text-xs font-medium capitalize ${statusBadge(cls.status)}`}
                        >
                          {cls.status}
                        </span>
                      </td>
                      <td className="px-4 py-3">
                        <div className="flex gap-2">
                          <button
                            ...
                            className="p-2 rounded-lg glass text-blue-400 hover:text-blue-300 transition-colors"
                          >
                            <FiEdit2 size={14} />
                          </button>
                          <button
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="sm:col-span-2">
                    ...
                    <input
                      ...
                      placeholder="e.g. Advanced Bridal Makeup"
                      required
                    />
                  </div>
                  <div className="sm:col-span-2">
      ...
      <option value="vip">VIP</option>
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <input
                      ...
                      className="input-beauty"
                      placeholder="bridal, luxury, wedding"
                    />
                  </div>
                  <div className="sm:col-span-2">
                    <label className="text-gray-400 text-xs mb-1 block">
