    ...
    <DashboardLayout>
      <div className="space-y-7">
        ...
        <div
          ...
          style={{
            background: "linear-gradient(135deg,#1a0020,#3d0030)",
        ...
        >
          ...
          <p className="text-pink-200 text-sm">
            Here's what's happening at Beauty Master Academy today.
          </p>
        </div>
          ...
          <div className="glass rounded-2xl overflow-hidden">
            <div className="p-5 border-b border-white/10 flex items-center justify-between">
              <h2 className="text-white font-semibold flex items-center gap-2">
                <FiDollarSign className="text-green-400" size={17} /> Recent
                Payments
              </h2>
              <Link
                to="/admin/payments"
                className="text-pink-400 text-xs flex items-center gap-1 hover:text-pink-300"
              >
  ...
  `https://ui-avatars.com/api/?name=${encodeURIComponent(
    p.userId?.name || "User"
          ...
          <div className="glass rounded-2xl overflow-hidden">
            <div className="p-5 border-b border-white/10 flex items-center justify-between">
              <h2 className="text-white font-semibold flex items-center gap-2">
                <FiUsers className="text-pink-400" size={17} /> New Students
              </h2>
              <Link
                to="/admin/students"
                className="text-pink-400 text-xs flex items-center gap-1 hover:text-pink-300"
                ...
                {recentStudents.map((s) => (
                  ...
                  >
                    <img
                      src={
                        s.avatar ||
                        `https://ui-avatars.com/api/?name=${s.name}&background=9C27B0&color=fff&size=40`
                      }
                      alt=""
                      className="w-9 h-9 rounded-lg object-cover flex-shrink-0"
                    />
                    ...
                    <span
                      ...
                      style={{
                        background: s.subscriptionActive
                          ? "rgba(16,185,129,0.12)"
                          : "rgba(107,114,128,0.12)",
                        color: s.subscriptionActive ? "#10B981" : "#9ca3af",
                        border: `1px solid ${s.subscriptionActive ? "rgba(16,185,129,0.2)" : "rgba(107,114,128,0.2)"}`,
                      }}
                    >
